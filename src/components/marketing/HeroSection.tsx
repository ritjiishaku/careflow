...
export function HeroSection() {
  return (
    <section className="relative bg-deep-navy h-dvh flex flex-col text-white overflow-hidden">
      ...
      {/* ── Logo (nav position) ── */}
      <div className="relative z-10 shrink-0 flex items-center h-14 sm:h-16 border-b border-white/5">
      ...
      <div className="flex-1 flex items-center min-h-0">
        <div className="mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8 relative z-10 pb-4 lg:pb-6">
